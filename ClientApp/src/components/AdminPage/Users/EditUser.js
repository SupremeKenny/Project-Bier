...
export class EditUser extends React.Component {
	...
	componentWillMount() {
		fetch("/account/FetchId/" + this.props.match.params.id)
		.then(results => {
	...
	handleSubmit = () => {
		...
		if (this.state.id !== "") {
			console.log("Uitgevoerd")
				fetch("account/Update/" + this.props.match.params.id + "/" + this.state.email, {
					headers: {
