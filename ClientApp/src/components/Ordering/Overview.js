...
class Overview extends Component {
  ...
  fetchAddressFromServer(email) {
    fetch("account/getaccountinfo?id=" + email, {
      method: "GET",
      headers: {
        ...
        results.json().then(data => {
          this.setState({
            ...
            userInfo: {
              ...
              name: this.props.reduxState.login.userName,
              email: this.props.reduxState.login.email,
            ...
            <Grid columns="equal">
              <Grid.Row columns="equal">
                ...
                <Grid.Column>
                  ...
                  <Card>
                    <Card.Content header={this.state.userInfo.name} />
                    <Card.Content meta={this.state.userInfo.email} />
                    <Card.Content
                      description={
                    ...
                    <Card.Content
                      description={this.state.userInfo.province + ", Nederland"}
                    />
                  </Card>
