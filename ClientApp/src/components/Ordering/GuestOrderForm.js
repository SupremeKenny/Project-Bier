...
class InputInfo extends Component {
  ...
  componentWillMount() {
    this.setState({ products: this.props.reduxState.products });
  }
    ...
    if (this.state.displayErrorForm) {
      errorForm = (
        <Message
          ...
          content="Om de bestelling correct te verwerken, moet u alle informatie in het formulier invullen."
        />
      );
    } else errorForm = "";
